    ...
    ConvexHull.prototype = Object.create(Visualization.prototype, {
        ...
        control : {
            value : function(){
                ...
                folder.add(this, 'hull_roundlen', 0, 25).step(2).onFinishChange(function(){
                    _this.display();
                });
                folder.add(this, 'hull_bend', 0, 15).step(1).onFinishChange(function(){
                    _this.display();
                });

                folder.add(this, 'hull_fill_opacity', 0, 1).step(0.1).onFinishChange(function(){
                    _this.update();
                });

                folder.add(this, 'hull_color_set').onFinishChange(function(){
                    _this.update();
                });
