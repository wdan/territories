...
class GraphImporter(object):
    ...
    def get_dblp_os(self):
        ...
        dblp = DBLP([853, 1074, 1615, 1451, 890], 'os_5', 'author')
        return dblp.g

    def get_dblp_os_paper(self):
        dblp = DBLP([853, 1074, 1615, 1451, 890], 'os_5', 'paper')
        return dblp.g
...
#        return self.get_dblp_paper([2308, 1984, 1512, 3078, 2960])
    def get_dblp_vis_paper(self):
        dblp = DBLP([2308, 1984, 1512, 379, 2960], 'vis_5', 'paper')
        return dblp.g

    def get_dblp_vis_big(self):
        dblp = DBLP([1731, 2769, 1512, 1575, 1984, 2012, 2027, 2308], 'vis_big', 'author')
        return dblp.g
